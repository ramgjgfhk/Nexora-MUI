...
import { Button, Dialog, DialogTitle, DialogContent, DialogActions, TextField, IconButton, InputAdornment, Tooltip } from '@mui/material';
import { FilterList, Close, Search, FilterAlt, Cancel } from '@mui/icons-material';


const FilterModalComponent = React.memo(({ fields = [  ] ,onApply,appliedFilters,setAppliedFilters}) => {
          ...
          {fields.length === 0 ? (
            ...
            fields.map((field, index) => (
                <TextField
                    ...
                    } ,my:1.5,mr:2,width:"30%", '& .MuiInputLabel-root': {
  ...
  sx={{
    ...
    borderRadius: '5px',
    // padding: '4px 12px',
    borderColor: '#d32f2f',textTransform:"capitalize",  fontSize: "12px",
    '&:hover': {
